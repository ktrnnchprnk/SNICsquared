...
%% Plot phase portrait in the E-A plane
...
% Trajectories
plot(Y1(:,1),Y1(:,3),'Color',colour.blue,'LineWidth',2)
plot(Y2(:,1),Y2(:,3),'Color',colour.blue,'LineWidth',2)
plot(Y3(:,1),Y3(:,3),'Color',colour.blue,'LineWidth',2)
plot(Y4(:,1),Y4(:,3),'Color',colour.blue,'LineWidth',2)

% Equilibria
n = 1;
plot(U(n,1),U(n,3),'o','MarkerFaceColor','k', ...
    'MarkerEdgeColor','black','MarkerSize',9,'LineWidth',1)

n = 2;
plot(U(n,1),U(n,3),'^','MarkerFaceColor','w', ...
    'MarkerEdgeColor','black','MarkerSize',8,'LineWidth',1)

n = 3;
plot(U(n,1),U(n,3),'o','MarkerFaceColor','w', ...
    'MarkerEdgeColor','black','MarkerSize',9,'LineWidth',1)
