...
% Trajectories
plot(Y1(:,2),Y1(:,3),'Color',colour.blue,'LineWidth',2)
plot(Y2(:,2),Y2(:,3),'Color',colour.blue,'LineWidth',2)
plot(Y3(:,2),Y3(:,3),'Color',colour.blue,'LineWidth',2)
plot(Y4(:,2),Y4(:,3),'Color',colour.blue,'LineWidth',2)

% Equilibria
n = 1;
plot(U(n,2),U(n,3),'o','MarkerFaceColor','k', ...
    'MarkerEdgeColor','black','MarkerSize',9,'LineWidth',1)

n = 2;
plot(U(n,2),U(n,3),'^','MarkerFaceColor','w', ...
    'MarkerEdgeColor','black','MarkerSize',8,'LineWidth',1)

n = 3;
plot(U(n,2),U(n,3),'o','MarkerFaceColor','w', ...
    'MarkerEdgeColor','black','MarkerSize',9,'LineWidth',1)
